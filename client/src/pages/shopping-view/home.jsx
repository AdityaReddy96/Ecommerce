...
import { Button } from "@/components/ui/button";
import bannerOne from "../../assets/banner-1.png"; // Main hero image
import bannerTwo from "../../assets/banner-2.png"; // Seasonal collection
import bannerThree from "../../assets/banner-3.jpg"; // New arrivals
import mobileBannerOne from "../../assets/mobile-banner-1.jpg"; // Optimized for mobile
import mobileBannerTwo from "../../assets/mobile-banner-2.jpg";
import mobileBannerThree from "../../assets/mobile-banner-3.jpg";
import { GiFootTrip } from "react-icons/gi";
import { SiNike, SiPuma } from "react-icons/si";
import { CgAdidas } from "react-icons/cg";
import wrognLogo from "../../assets/wrogn-brand.png";
...
import { toast } from "sonner";
import { ProductDetails } from "@/components/shopping-view/product-details";
import { useMediaQuery } from "../../components/shopping-view/use-media-query.jsx";
...
export const ShoppingHome = () => {
  ...
  const desktopSlides = [bannerOne, bannerTwo, bannerThree];

  const mobileSlides = [
    mobileBannerOne,
    mobileBannerTwo,
    mobileBannerThree, // Fallback if no mobile-specific image
  ];
